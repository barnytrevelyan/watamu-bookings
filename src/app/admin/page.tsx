    ...
    try {
      ...
      const [
        ...
        supabase
          .from('wb_bookings')
          .select('*', { count: 'exact', head: true }),
        // All bookings contribute to platform commission — commission-only model.
        supabase
          .from('wb_bookings')
          .select('total_price, property_id, boat_id')
      ...
      // Commission-only model — all bookings count toward the commission base.
      const commissionableRevenue = totalRevenue;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <Card className="border-indigo-200 bg-indigo-50 p-5">
          <p className="text-sm text-indigo-600">Platform Commission (7.5%)</p>
